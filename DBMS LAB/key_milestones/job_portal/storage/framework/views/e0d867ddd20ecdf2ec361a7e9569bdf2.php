  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav ms-auto mb-2 mb-md-0">
        <li class="nav-item"><a class="nav-link active" href="<?php echo e(route('dashboard')); ?>">Home</a></li>
        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('jobs.index')); ?>">View Jobs</a></li>

        <?php if(session('user') && session('user')->UserType === 'jobseeker'): ?>
          <li class="nav-item"><a class="nav-link" href="<?php echo e(route('jobseeker.applications')); ?>">My Applications</a></li>
        <?php endif; ?>

        <?php if(session('user') && session('user')->UserType === 'employer'): ?>
          <li class="nav-item"><a class="nav-link" href="<?php echo e(route('jobs.create')); ?>">Post Job</a></li>
        <?php endif; ?>
...
<?php if(session('user') && session('user')->UserID == 13 && session('user')->UserType === 'employer'): ?>
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.page')); ?>">Admin</a>
    </li>
<?php endif; ?>
...
<section class="hero-section">
  <div class="container hero-overlay text-center">
    <div class="hero-text">
      ...
      <p class="mt-2">Hello, <strong><?php echo e(session('user')->Name); ?></strong>! 👋</p>
      <p>Connecting top talent with the best companies worldwide.</p>
      <a href="<?php echo e(route('jobs.index')); ?>" class="btn btn-explore btn-lg mt-4">Explore Job Openings</a>
    </div>
  </div>
</section>
...
<?php /**PATH D:\Semester_Data\6th_semester\DBMS LAB\key_milestones\job_portal\resources\views/dashboard.blade.php ENDPATH**/ ?>